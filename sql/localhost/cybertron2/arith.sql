...
CREATE TABLE IF NOT EXISTS `arith_battle_tbl` (
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'waitPlayer' COMMENT '对战状态,waitPlayer-等待参与者加入，waitReady-等待参与者准备好，waitStart-等待创建者开始，battling-对战中，over-结束',
  `winner` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '胜利者名称，draw-平局',
